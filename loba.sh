...
cp -rf target/auth-client-service-0.0.1-SNAPSHOT.war auth-loba-docker/loba/

cd auth-loba-docker/loba/  && rm -rf auth-client && unzip -qq  auth-client-service-0.0.1-SNAPSHOT.war -d auth-client && rm -rf auth-client-service-0.0.1-SNAPSHOT.war
