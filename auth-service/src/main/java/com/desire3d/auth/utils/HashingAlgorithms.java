...
public final class HashingAlgorithms {
	...
	public static HashingAlgorithms getInstance() {
		return hashAlgo;
	}
	 ...
	 * 5 SHA-512	(512 bit Strong hash - check US export controls)
	 *
	 * @param String _message, int _algo
	 * @return String (computed hash value)
	 * @throws Exception
	 */
	 ...
	 *
	 * @param String _message, int _algo, String _encoding
	 ...
	 */
	/** Method name change from main to test by Mahesh Pardeshi for command-line app run */
